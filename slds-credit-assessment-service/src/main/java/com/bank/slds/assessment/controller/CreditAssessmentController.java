...
import com.bank.slds.assessment.constant.ApiPath;
...
@RestController
@RequestMapping(ApiPath.CreditAssessment.BASE)
...
public class CreditAssessmentController {
    ...
    @PostMapping(ApiPath.CreditAssessment.EVALUATE)
    ...
    @GetMapping(ApiPath.CreditAssessment.CIC_HISTORY)
    ...
    @GetMapping(ApiPath.CreditAssessment.LOGS)
